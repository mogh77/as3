g(msg.to.id, name_log.." ["..msg.from.id.."] set group to: unmute "..msg_type)
	...
	--Begin chat muteuser
		if matches[1] == "muteuser" and is_mod(msg) then
  ...
  --End Chat muteuser
  	if matches[1] == "muteslist" and is_mod(msg) then
		local chat_id = msg.to.id
    ...
    if matches[1] == 'settings' and is_mmod(msg) then
...
if msg.to.type == 'chat' then
    ...
    if matches[1] == 'help' then
      if not is_mod(msg) or is_realm(msg) then
        return
      end
